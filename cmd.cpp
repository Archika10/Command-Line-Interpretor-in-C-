...
{
	     	char ext[100];
	     	strcpy(ext,arr);  //arr contains the command name, check for available options
		...
		if(strstr(arr,"=")!=NULL)
		{
			...
			if((strstr(arr,"= ")!=NULL)||(strstr(arr," =")!=NULL)) //It contains spaces, so envt variable cant be initiaized
			{
